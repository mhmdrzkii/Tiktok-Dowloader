...
load_dotenv()
bot_token = ('5671909288:AAGpafFbwjMaNtamIA1lNfbyN99pH2dBmUY')
api = ('10125621')
workers = ('4')
hash = ('739e1f63d226674e24c0848129f0303c')
chnnl = ('https://t.me/tiktokdownloaderfree')
BOT_URL = ('tiktokfreedownloader_bot')
app = Client("Rishky", bot_token=bot_token, api_id=api, api_hash=hash, workers=workers )



@app.on_message(filters.command('start'))
def start(client, message):
    kb = [[InlineKeyboardButton('Channel 🛡', url=chnnl),InlineKeyboardButton('Donate 🔰', url="saweria.com/rzkiyy")]]
